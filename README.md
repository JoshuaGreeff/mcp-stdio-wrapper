...
[![Publish](https://img.shields.io/github/actions/workflow/status/JoshuaGreeff/mcp-stdio-wrapper/release.yml?label=publish)](https://github.com/JoshuaGreeff/mcp-stdio-wrapper/actions/workflows/release.yml)
